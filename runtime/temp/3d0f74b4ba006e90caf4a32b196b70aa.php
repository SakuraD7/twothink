<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/property\edit.html";i:1542010985;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">报修原因<span class="check-tips">（用于显示的文字）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="reason" value="<?php echo (isset($info['reason']) && ($info['reason'] !== '')?$info['reason']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">业主姓名<span class="check-tips">（用于显示的文字）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="name" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">联系方式<span class="check-tips">（用于显示的文字）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">详细描述<span class="check-tips">（用于显示的文字）</span></label>
			<div class="textarea input-large">
				<textarea name="contents" ><?php echo (isset($info['contents']) && ($info['contents'] !== '')?$info['contents']:''); ?></textarea>
				<!--<input type="text" class="text input-large" name="contents" value="<?php echo (isset($info['contents']) && ($info['contents'] !== '')?$info['contents']:''); ?>">-->
			</div>
		</div>
		<div class="form-item">
