<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\twothink\public/../application/user/view/default/login\index.html";i:1542252608;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
...
<div class="main">
  <div class="container-fluid">
    <form class="login-form" action="" method="post">
      ...
      <div class="form-group">
        <label>密码</label>
        <input type="text" class="form-control" placeholder="请输入密码"  errormsg="密码为6-20位" nullmsg="请填写密码" datatype="*6-20" name="password"/>
      </div>
      <div class="form-group">
        <label >验证码</label>
        <div class="controls">
